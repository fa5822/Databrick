...
KPI_gold = 'eMTC_Downlink_PDCP_Throughput_KPI_gold'
...
# MAGIC (
# MAGIC         select CalendarDate,hour24    from  eMTCPDCPPacket_lte_hr_silver
# MAGIC )k
...
# MAGIC eMTC_PdcpVolDlByte eMTC_Downlink_PDCP_Throughput_NUM,
# MAGIC eMTC_PdcpTimeDl eMTC_Downlink_PDCP_Throughput_DENOM
# MAGIC from (
# MAGIC 	select 
# MAGIC 	CalendarDate,hour24,NE_ID,LOCATION,	LOCATION2,
# MAGIC 	sum(eMTC_PdcpVolDlByte) eMTC_PdcpVolDlByte,
# MAGIC 	sum(eMTC_PdcpTimeDl) eMTC_PdcpTimeDl
# MAGIC 	from (
# MAGIC 			select CalendarDate,hour24,NE_ID,LOCATION,split(LOCATION,'/')[0] LOCATION2,
# MAGIC 			sum(eMTC_PdcpVolDlByte_Kbytes_SUM) eMTC_PdcpVolDlByte,
# MAGIC 			sum(eMTC_PdcpTimeDl_ms_SUM) eMTC_PdcpTimeDl
# MAGIC 			-- select *
# MAGIC 			from 
# MAGIC 			eMTCPDCPPacket_lte_hr_silver
