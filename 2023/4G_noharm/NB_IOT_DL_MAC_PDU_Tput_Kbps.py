...
KPI_gold = 'NB_IOT_DL_MAC_PDU_Tput_Kbps_KPI_gold'
...
# MAGIC NBIoT_AirMacDLByte NB_IOT_DL_MAC_PDU_Tput_Kbps_NUM,
# MAGIC NBIoT_AirMacDLByteCnt NB_IOT_DL_MAC_PDU_Tput_Kbps_DENOM
# MAGIC from (
# MAGIC 	select 
...
# MAGIC 			-- select *
# MAGIC 			from 
# MAGIC 			NBIoTAirMACULandDLpackets_lte_hr_silver
