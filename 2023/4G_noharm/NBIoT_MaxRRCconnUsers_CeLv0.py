...
KPI_gold = 'NBIoT_MaxRRCconnUsers_CeLv0_KPI_gold'
...
# MAGIC (
# MAGIC         select CalendarDate,hour24    from  nbiotrrcconnectionnumber_lte_hr_silver
# MAGIC )k
...
# MAGIC (NBIOT_CONNNOCELV0MAX) NBIoT_MaxRRCconnUsers_CeLv0
# MAGIC from (
# MAGIC 	select 
...
# MAGIC 			-- select *
# MAGIC 			from 
# MAGIC 			nbiotrrcconnectionnumber_lte_hr_silver
