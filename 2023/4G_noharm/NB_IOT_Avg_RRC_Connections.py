...
KPI_gold = 'NB_IOT_Avg_RRC_Connections_KPI_gold'
...
# MAGIC (NBIoT_ConnNoTot) NB_IOT_Avg_RRC_Connections_NUM,	
# MAGIC (NBIoT_ConnNoCnt) NB_IOT_Avg_RRC_Connections_DENOM
# MAGIC from (
# MAGIC 	select 
