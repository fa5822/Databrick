...
KPI_gold = 'DL_MAC_Layer_Data_Volume_CA_KPI_gold'
...
# MAGIC         (AirMacDLByte_P+AirMacDLByte_S) DL_MAC_Layer_Data_Volume
# MAGIC         from (
# MAGIC             select 
...
# MAGIC %sql
# MAGIC select * from dl_mac_layer_data_volume_ca_kpi_gold where enodeb_id like '%100006%' and FREQUENCY_BAND_INDICATOR = 13 and ECELL_ID = 'cNum1' and daily = '2023-05-01' 
