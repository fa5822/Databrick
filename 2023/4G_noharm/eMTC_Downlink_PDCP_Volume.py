...
KPI_gold = 'eMTC_Downlink_PDCP_Volume_KPI_gold'
...
# MAGIC (
# MAGIC         select CalendarDate,hour24    from  hive_metastore.`default`.eMTCPDCPPacket_lte_hr_silver
# MAGIC )k
...
# MAGIC eMTC_PdcpVolDlByte eMTC_Downlink_PDCP_Volume
# MAGIC from (
# MAGIC 	select 
...
# MAGIC 			-- select *
# MAGIC 			from 
# MAGIC 			hive_metastore.`default`.eMTCPDCPPacket_lte_hr_silver
