...
KPI_gold = 'eMTC_Paging_Attempt_KPI_gold'
...
# MAGIC (
# MAGIC         select CalendarDate,hour24    from  eMTCPagingAttempts_lte_hr_silver
# MAGIC )k
...
# MAGIC eMTC_AttPaging eMTC_Paging_Attempt
# MAGIC from (
# MAGIC 	select 
# MAGIC 	CalendarDate,hour24,NE_ID,LOCATION,	
# MAGIC 	sum(eMTC_AttPaging) eMTC_AttPaging
# MAGIC 	from (
# MAGIC 			select CalendarDate,hour24,NE_ID,LOCATION,
# MAGIC 			sum(eMTC_AttPaging_count_SUM) eMTC_AttPaging
# MAGIC 			-- select *
# MAGIC 			from 
# MAGIC 			eMTCPagingAttempts_lte_hr_silver
