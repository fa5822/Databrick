...
KPI_gold = 'eMTC_Avg_RRC_Connected_Users_KPI_gold'
...
# MAGIC eMTC_ConnNoTot eMTC_Avg_RRC_Connected_Users_NUM,
# MAGIC eMTC_ConnNoCnt eMTC_Avg_RRC_Connected_Users_DENOM
# MAGIC from (
# MAGIC 	select 
