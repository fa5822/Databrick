...
KPI_gold = 'NB_IOT_RRC_Conn_Setup_Failure_Rate_KPI_gold'
...
# MAGIC (
# MAGIC         select CalendarDate,hour24    from  hive_metastore.`default`.nbiotrrcconnectionestablishmentpercelevel_lte_hr_silver
# MAGIC )k
...
# MAGIC (NBIoT_ConnEstabAtt - NBIoT_ConnEstabSucc)	NB_IOT_RRC_Conn_Setup_Failures_num,
...
# MAGIC 			from 
# MAGIC 			hive_metastore.`default`.nbiotrrcconnectionestablishmentpercelevel_lte_hr_silver
